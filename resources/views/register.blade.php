<x-base>
    <div class="flex justify-center items-center h-full">
        <form class="w-auto h-auto bg-blue-100 rounded-xl flex items-center justify-between flex-col p-4" method="POST" action="{{ route('') }}">
            @csrf
            <h1 class="font-semibold text-2xl mb-4">Sign Up</h1>
            <div class="flex items-center justify-center flex-col mb-4">
                <input class="bg-white px-4 py-2 rounded-xl mb-2" type="text" name="username" placeholder="Username..." />
